<template>
	...
	>
		<form @submit="handleSubmit($event, editTask)">
			<CustomInput
				v-model="form.title"
				name="title"
				label="Назва"
			...
			<CustomSelect
				...
				:items="priorities"
			/>
			<CustomButton type="submit"> Редагувати задачу </CustomButton>
		</form>
	</VeeForm>
</template>
...
Object.assign(form.value, {
	...
	status: boards.value.find((b) => b.id === state.value.data?.categoryId),
});
